...
<body style="background-color:#F2F2F2;">
    <div style="background-color:#F2F2F2;">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <div
                                                style="font-family:Helvetica, Arial, sans-serif;font-size:11px;font-weight:400;line-height:24px;text-align:center;color:#9B9B9B;">
                                                Email xác nhận đơn hàng</div>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            <div
                                                style="font-family:Helvetica, Arial, sans-serif;font-size:20px;font-weight:500;line-height:24px;text-align:left;color:#000000;">
                                                Fashi Shop</div>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="right"
                                            style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            <div
                                                style="font-family:Helvetica, Arial, sans-serif;font-size:11px;font-weight:400;line-height:24px;text-align:right;color:#000000;">
                                                <a href="#" style="color: #000000; text-decoration: none;">CHẤT
                                                    LƯỢNG</a>&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;<a href="#"
                                                    style="color: #000000; text-decoration: none;">UY
                                                    TÍN</a>&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;<a href="#"
                                                    style="color: #000000; text-decoration: none;">HÀNG ĐẦU</a></div>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <div
                                                style="font-family:Helvetica, Arial, sans-serif;font-size:32px;font-weight:300;line-height:40px;text-align:center;color:#5FA91D;">
                                                Đơn hàng đã xác nhận.</div>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <td style="direction:ltr;font-size:0px;padding:0 20px 20px 20px;text-align:center;">
                            ...
                            <div class="mj-column-per-80 mj-outlook-group-fix"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center"
                                            style="font-size:0px;padding:0px;padding-top:10px;word-break:break-word;">
                                            <div
                                                style="font-family:Helvetica, Arial, sans-serif;font-size:16px;font-weight:500;line-height:24px;text-align:center;color:#000000;">
                                                Chào {{ $shipping->shipping_name }}, đơn hàng
                                                {{ $shipping->order->order_id }} của bạn đã được gửi đi cho đơn vị vận
                                                chuyển. Cám ơn bạn đã sử dụng dịch vụ của chúng tôi!</div>
                                        </td>
                                    </tr>
                                </table>
                            </div>
        ...
        <div
            style="background:url(http://nimus.de/share/tpl-card/bg.jpg) center top / cover no-repeat;background-position:center top;background-repeat:no-repeat;background-size:cover;margin:0px auto;max-width:600px;">
            <div style="line-height:0;font-size:0;">
                <table align="center" background="http://nimus.de/share/tpl-card/bg.jpg" border="0" cellpadding="0"
                    cellspacing="0" role="presentation"
                    style="background:url(http://nimus.de/share/tpl-card/bg.jpg) center top / cover no-repeat;background-position:center top;background-repeat:no-repeat;background-size:cover;width:100%;">
                    <tbody>
                        <tr>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div
                                                    style="font-family:Helvetica, Arial, sans-serif;font-size:16px;font-weight:300;line-height:24px;text-align:center;color:#000000;">
                                                    {{ $shipping->shipping_name }} - {{ $shipping->shipping_address }} -
                                                    {{ $shipping->shipping_phone }} - {{ $shipping->shipping_email }}
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                                    ...
                                                    <tr>
                                                        <td align="center" bgcolor="#5FA91D" role="presentation"
                                                            ...
                                                            valign="middle"><a href="#"
                                                                style="display:inline-block;background:#5FA91D;color:#FFFFFF;font-family:Helvetica, Arial, sans-serif;font-size:13px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:15px 30px;mso-padding-alt:0px;border-radius:2px;"
                                                                target="_blank">Hỗ trợ</a></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0px;padding:0px;word-break:break-word;">
                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:600px;"><img alt="bottom border" height="auto"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <div
                                                style="font-family:Helvetica, Arial, sans-serif;font-size:11px;font-weight:400;line-height:24px;text-align:center;color:#9B9B9B;">
                                                <a href="https://www.facebook.com/levantanlop91"
                                                    style="color: #9B9B9B;">Email:</a>
                                                lvtan.19it1@vku.udn.vn<br>VKU<br><a
                                                    href="https://www.facebook.com/levantanlop91"
                                                    style="color: #9B9B9B; text-decoration:none;">Made with love</a>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
