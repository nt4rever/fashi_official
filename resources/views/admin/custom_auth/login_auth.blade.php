...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="index2.html"><b>Admin</b> fashi</a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">Sign in to start your session (Auth)</p>
                ...
                <p class="mb-1">
                    <a href="{{ URL::to('/login-auth') }}" class="badge badge-secondary">I forgot my password</a>
                </p>
