    ...
    <div class="row">
        <div class="col-md-7 mt-3">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" action="{{ URL::to('/ad/save-edit-deal/'.$deal->deal_id) }}" method="post">
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select name="product_id" class="form-control choose_product">
                                ...
                                <option value="{{ $item->product_id }}"
                                    {{ $deal->product_id==$item->product_id?"selected":'' }}>{{ $item->product_name }}
                                </option>
                                @endif
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control money price" name="price" readonly
                                value="{{ $deal->product->product_price }}">
                        </div>
                        <div class="form-group">
                            <label for="price_discount">Price discount</label>
                            <input type="text" class="form-control money price_discount" name="price_discount"
                                value="{{ $deal->product->product_price_discount }}" required>
                        </div>
                        <div class="form-group">
                            <label>Date:</label>
                            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                <input type="text" class="form-control datetimepicker-input"
                                    data-target="#reservationdate" name="deal_time" value="{{ $deal->deal_time }}" />
