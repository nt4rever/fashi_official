                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="coupon_condition" name="coupon_condition">
                                ...
                                <option value="1" {{ $coupon->coupon_condition==1?"selected":"" }}>Giảm theo phần trăm
                                </option>
                                <option value="2" {{ $coupon->coupon_condition==2?"selected":"" }}>Giảm theo tiền
                                </option>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="coupon_number" name="coupon_number"
                                placeholder="1000" value="{{ $coupon->coupon_number }}" required>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control float-right" name="coupon_date_time"
                                    id="reservationtime" value="{{ $coupon->coupon_start." - ".$coupon->coupon_end }}"
                                    required>
                            </div>
                            <!-- /.input group -->
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" id="coupon_status" name="coupon_status">
                                <option value="0" {{ $coupon->coupon_status==0?"selected":"" }}>Hoạt động
                                </option>
                                <option value="1" {{ $coupon->coupon_status==1?"selected":"" }}>Ẩn
                                </option>
                            </select>
                        </div>
                        @if ($errors->any())
