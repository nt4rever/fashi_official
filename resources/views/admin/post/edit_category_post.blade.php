    ...
    <div class="row">
        <div class="col-md-7 mt-3">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" action="{{ URL::to('/save-edit-category-post/'.$category_post->category_post_id) }}"
                    method="post" id="form_add_category_post">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="textarea" name="category_post_desc" id="category_post_desc"
                                ...
                                required>{{ $category_post->category_post_desc }}</textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" id="category_post_status" name="category_post_status">
                                <option value="0" {{ $category_post->category_post_status==0? 'selected' :'' }}>Hiển thị
                                </option>
                                <option value="1" {{ $category_post->category_post_status==1? 'selected' :'' }}>Ẩn
                                </option>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="convert_slug" name="category_post_slug"
                                ...
                                value="{{ $category_post->category_post_slug }}">
                        </div>
                    </div>
                    <!-- /.card-body -->
