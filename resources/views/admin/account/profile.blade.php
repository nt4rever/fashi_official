                        ...
                        <div class="tab-content">
                            <div class="tab-pane" id="activity">
                                ...
                                <div class="post clearfix">
                                    <div class="user-block">
                                        <img class="img-circle img-bordered-sm"
                                            src="{{ url('backend/dist/img/user7-128x128.jpg') }}" alt="User Image">
                                        <span class="username">
                                            <a href="#">Sarah Ross</a>
                                            <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                                        </span>
                                ...
                                <div class="post">
                                    <div class="user-block">
                                        <img class="img-circle img-bordered-sm"
                                            src="{{ url('backend/dist/img/user6-128x128.jpg') }}" alt="User Image">
                                        <span class="username">
                                            <a href="#">Adam Jones</a>
                                            <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                                        </span>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-6">
                                            <img class="img-fluid" src="{{ url('backend/dist/img/photo1.png') }}"
                                                alt="Photo">
                                        </div>
                                        <!-- /.col -->
                                        <div class="col-sm-6">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <img class="img-fluid mb-3"
                                                        src="{{ url('backend/dist/img/photo2.png') }}" alt="Photo">
                                                    <img class="img-fluid"
                                                        src="{{ url('backend/dist/img/photo3.jpg') }}" alt="Photo">
                                                </div>
                                                <!-- /.col -->
                                                <div class="col-sm-6">
                                                    <img class="img-fluid mb-3"
                                                        src="{{ url('backend/dist/img/photo4.jpg') }}" alt="Photo">
                                                    <img class="img-fluid"
                                                        src="{{ url('backend/dist/img/photo1.png') }}" alt="Photo">
                                                </div>
                                                <!-- /.col -->
                                            </div>
                                            <!-- /.row -->
                            ...
                            <div class="tab-pane active" id="settings">
                                <form class="form-horizontal" action="{{ URL::to('/ad/save-my-account') }}"
                                    method="post">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        <label for="inputExperience" class="col-sm-2 col-form-label">Old
                                            password</label>
                                        <div class="col-sm-10">
                                            <input type="password" class="form-control" name="admin_old_password"
                                                required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label for="inputSkills" class="col-sm-2 col-form-label">Repeat new
                                            password</label>
                                        <div class="col-sm-10">
                                            <input type="password" class="form-control" name="admin_repeat_password"
                                                required>
                                        </div>
                                    </div>
