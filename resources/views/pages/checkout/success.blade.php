            ...
            <div class="row">
                    ...
                    <div class="place-order">
                        ...
                        <div class="order-total">
                            <ul class="order-table">
                                ...
                                @endif
                                @endforeach
                                <li class="total-price">{{ __('Discount') }} <span>{{ number_format($discount) }} đ</span></li>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="place-order">
                        ...
                        <a href="{{ URL::to('/home') }}" class="badge badge-dark"><i class="fa fa-home"></i> {{ __('Back to home') }}</a>
                    </div>
                </div>
            </div>
        </form>
